...
export default function PageAdd() {
    ...
    const handleZipCodeInput: InputZipCode = (e) => {
    ...
    return (
        <div className="p-4">
            ...
            <form>
                <FormInput placeholder="Nama" message={form.name.message} isError={form.name.isError} label="Nama" value={form.name.value} onChangeText={handleInput('name')} />
                <FormInput placeholder="Email" message={form.email.message} isError={form.email.isError} label="Email" value={form.email.value} onChangeText={handleInput('email')} />
                <FormInput placeholder="Address" message={form.address.message} isError={form.address.isError} label="Alamat" value={form.address.value} onChangeText={handleInput('address')} />
                <FormInput placeholder="City" message={form.city.message} isError={form.city.isError} label="City" value={form.city.value} onChangeText={handleInput('city')} />
                <FormInput placeholder="Suite" message={form.suite.message} isError={form.suite.isError} label="Suite" value={form.suite.value} onChangeText={handleInput('suite')} />
                <FormInput placeholder="Zipcode" message={form.zipcode.message} isError={form.zipcode.isError} label="Zipcode" value={form.zipcode.value} onChangeText={handleZipCodeInput} />
                <FormInput placeholder="Company" message={form.company.message} isError={form.company.isError} label="Company" value={form.company.value} onChangeText={handleInput('company')} />
                {/* success alert */}
